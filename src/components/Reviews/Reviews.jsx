                ...
                >
                    <SwiperSlide className={styles.slide}>
                        <div>
                            ...
                            <p>
                                Iskender Company является ведущим международным производителем дизайнерской мебели для
                                ванных комнат. Мы создаём мебель, чтобы предложить нашим клиентам уникальную мебель,
                                полностью изготовленную нами в Кыргызстане, со страстью и вниманием, потому что мы
                                хотим, чтобы Iskender была синонимом качества и надёжности.
                            </p>
